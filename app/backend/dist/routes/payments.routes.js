...
const ctrl = __importStar(require("../controllers/payments.controller"));
...
router.post('/', [
    ...
    (0, express_validator_1.body)('paymentDate').notEmpty(),
], validation_middleware_1.validateRequest, ctrl.addPayment);
