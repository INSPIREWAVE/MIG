...
async function seed() {
  ...
  const adminResult = await dbModule.registerUser(
    'admin', 'Admin@2026', 'admin',
    'What is your mother\'s maiden name?', 'Chanda'
  );
  ...
  const managerResult = await dbModule.registerUser(
    'manager', 'Manager@2026', 'manager',
    'What city were you born in?', 'Lusaka'
  );
